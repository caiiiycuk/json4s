  ...
  object Reflection {
    ...
    */
    def primitive2jvalue(a: Any) = a match {
      ...
      case x: Int => JInt(x)
      case x: Long => JInt(x)
      case x: Double => JDouble(x.floatValue)
      case x: Float => JDouble(x)
      case x: Byte => JInt(x)
      case x: BigInt => JInt(x.longValue())
      case x: Boolean => JBool(x)
      case x: Short => JInt(x)
      case x: java.lang.Integer => JInt(x.asInstanceOf[Int])
      case x: java.lang.Long => JInt(x.asInstanceOf[Long])
      case x: java.lang.Double => JDouble(x.asInstanceOf[Double].floatValue())
      case x: java.lang.Float => JDouble(x.asInstanceOf[Float])
      case x: java.lang.Byte => JInt(x.asInstanceOf[Byte])
      case x: java.lang.Boolean => JBool(x.asInstanceOf[Boolean])
      case x: java.lang.Short => JInt(x.asInstanceOf[Short])
